...
export default function TimeCapsulePage() {
  ...
  const [form, setForm] = useState({
    ...
    from_person: "",
    to_person: "",
    open_date: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)
      .toISOString()
      .split("T")[0],
  });
  ...
  async function loadData() {
    ...
    if (profRes.data) {
      ...
      setForm((f) => ({
        ...f,
        from_person: profRes.data.person1_name,
        to_person: profRes.data.person2_name,
      }));
    }
    setLoading(false);
  }
  ...
  const daysLeft = (d: string) =>
    Math.max(0, differenceInDays(parseISO(d), new Date()));

  const locked = capsules.filter((c) => !isPast(parseISO(c.open_date)));
  const unlocked = capsules.filter(
    (c) => isPast(parseISO(c.open_date)) && !c.is_opened,
  );
    ...
    <div style={{ maxWidth: "700px", margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          >
            Pesan rahasia untuk dibuka di masa depan
          </p>
        </div>
        <button
          onClick={() => setShowModal(true)}
          className="btn-rose"
          style={{ gap: "6px", fontSize: "0.875rem", padding: "10px 20px" }}
        >
      ...
      {loading ? (
        ...
        >
          ...
          >
            Tuliskan pesan untuk dibuka di masa depan!
          </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                {locked.map((c) => (
                  ...
                  >
                    <div
                      style={{
                        background:
                          "linear-gradient(90deg, #2d8c6e08, #e8943a08)",
                        padding: "16px 20px",
                        display: "flex",
                        alignItems: "center",
                        gap: "16px",
                    ...
                    >
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        >
                          {daysLeft(c.open_date)}
                        </div>
                        <div
                          className="font-body"
                          style={{ fontSize: "0.7rem", color: "#a0c4b8" }}
                        >
                          hari lagi
                        </div>
                        <div
                        ...
                        >
                          {format(parseISO(c.open_date), "d MMM yyyy", {
                            locale: idLocale,
                          })}
                        </div>
                      </div>
          ...
          {unlocked.length > 0 && (
            <div>
              ...
              >
                <Unlock size={16} color="#22c55e" /> Siap Dibuka! (
                {unlocked.length})
              </h2>
              <div
                style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <p
                          className="font-body"
                          style={{ color: "#86efac", fontSize: "0.72rem" }}
                        >
                          ✨ Klik untuk membuka!
                        </p>
                      </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Dari {selectedCapsule.from_person} untuk{" "}
                {selectedCapsule.to_person}
              </p>
            </div>
            <div style={{ padding: "28px" }}>
              ...
              >
                🗓️ Dibuat{" "}
                {format(parseISO(selectedCapsule.created_at), "d MMMM yyyy", {
                  locale: idLocale,
                })}
              </p>
              <button
            ...
            >
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Untuk 1 tahun ke depan..."
                  value={form.title}
                  onChange={(e) =>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, open_date: e.target.value }))
                  }
                />
                <p
                  className="font-body"
              ...
              <div>
                ...
                <textarea
                  className="love-input paper-texture"
                  style={{ resize: "none" }}
                  rows={5}
