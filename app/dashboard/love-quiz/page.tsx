...
export default function LoveQuizPage() {
  ...
  function startQuiz() {
    ...
    setSession(
      shuffled.map((q) => ({ question: q, userAnswer: "", isCorrect: null })),
    );
    setCurrentIdx(0);
    setUserInput("");
    setShowAnswer(false);
  ...
  function submitAnswer() {
    const correct =
      ...
      session[currentIdx].question.answer.trim().toLowerCase();
        ...
        <div style={{ display: "flex", gap: "8px", flexShrink: 0, flexWrap: "wrap" }}>
          {questions.length > 0 && !quizMode && (
            <button
              onClick={startQuiz}
              style={{
                background: "linear-gradient(135deg,#a855f7,#e8943a)",
                color: "#fff",
                border: "none",
                borderRadius: "50px",
                padding: "10px 16px",
              ...
              {!showAnswer ? (
                <>
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && userInput.trim() && submitAnswer()
                    }
                ...
                <div>
                  ...
                  <div
                    style={{
                      ...
                      marginBottom: "16px",
                      textAlign: "center",
                      background: session[currentIdx].isCorrect
                        ? "#f0fdf4"
                        : "#fef2f2",
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{
                        fontWeight: 700,
                        color: session[currentIdx].isCorrect
                          ? "#15803d"
                          : "#dc2626",
                        fontSize: "0.95rem",
                        margin: "0 0 8px",
                      ...
                      >
                        ...
                        >
                          ...
                          <strong style={{ color: "#237a5e" }}>
                            {session[currentIdx].question.answer}
                          </strong>
                        </p>
                      </div>
                    )}
          ...
          >
            <div style={{ fontSize: "4rem", marginBottom: "12px" }}>
              {correctCount === session.length
                ...
                : correctCount >= session.length * 0.7
                  ? "🌟"
                  : correctCount >= session.length * 0.4
                    ? "🌿"
                    : "😅"}
            </div>
            <h2
            ...
            >
              {correctCount === session.length
                ...
                : correctCount >= session.length * 0.7
                  ? "Hampir sempurna! Masih perlu belajar sedikit lagi 😊"
                  : correctCount >= session.length * 0.4
                    ? "Lumayan! Tapi masih banyak yang perlu dipelajari 😄"
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p
                        ...
                        style={{
                          fontSize: "0.75rem",
                          margin: "0 0 2px",
                          color: s.isCorrect ? "#15803d" : "#dc2626",
                        }}
                      >
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                {SAMPLE_QUESTIONS.slice(0, 4).map((s) => (
                  <button
                    key={s}
                    onClick={() => setForm((f) => ({ ...f, question: s }))}
                    style={{
                      background: "#f4f9f7",
                      border: "1px solid #c8ddd5",
                      borderRadius: "8px",
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  {authorOptions.map((n) => (
                    <button
                      key={n}
                      onClick={() => setForm((f) => ({ ...f, asked_by: n }))}
                      style={{
                        flex: 1,
                        padding: "8px",
                        borderRadius: "10px",
