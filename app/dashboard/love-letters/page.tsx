...
export default function LoveLettersPage() {
  ...
  async function loadData() {
    ...
    if (profileRes.data) {
      ...
      setForm((f) => ({
        ...f,
        from_person: profileRes.data.person1_name,
        to_person: profileRes.data.person2_name,
      }));
    }
    setLoading(false);
  }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-rose-500 font-body text-sm mt-1">
            {letters.length} surat tersimpan dengan cinta
          </p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center py-16 glass rounded-3xl">
          ...
          <p className="text-rose-400 font-body text-sm mb-4">
            Ungkapkan perasaanmu lewat tulisan!
          </p>
          ...
          {letters.map((letter) => {
            ...
            return (
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${moodInfo.color}, #f4f9f7)`,
                }}
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, transparent, rgba(45,140,110,0.15), transparent)",
                    }}
                  />

                  <div className="mb-3">
                    <span className="text-xs font-body text-rose-400 italic">
                      Untuk: {letter.to_person} ✉️
                    </span>
                  </div>
                  <h3 className="font-display font-bold text-rose-800 text-lg mb-2 pr-8">
                    {letter.title}
                  </h3>
                  <p className="text-rose-600 font-body text-sm line-clamp-3 leading-relaxed">
                    {letter.content}
                  </p>
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-rose-100">
                    <span className="text-xs text-rose-400 font-body italic">
                      — {letter.from_person}
                    </span>
                    <span className="text-xs text-rose-400 font-body">
                      {format(parseISO(letter.created_at), "d MMM yyyy", {
                        locale: idLocale,
                      })}
                    </span>
                  </div>
      ...
      {selected && (
        ...
        >
          <div
            className="bg-amber-50 rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden"
          ...
          >
            ...
            <div className="p-6 pb-0">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <span
                    className="mood-badge mb-2 inline-block"
                    style={{ background: "#e3f0eb", color: "#2d8c6e" }}
                  >
                    {getMoodInfo(selected.mood).emoji}{" "}
                    {getMoodInfo(selected.mood).label}
                  </span>
            ...
            <div className="px-6 pb-6">
              <div
                className="paper-texture rounded-2xl p-6"
                style={{ border: "1px solid rgba(45,140,110,0.1)" }}
              >
                <p className="font-body text-rose-700 text-sm italic mb-4">
                  Kepada yang tercinta, {selected.to_person}...
                </p>
                <h2 className="font-display text-xl font-bold text-rose-800 mb-4">
                  {selected.title}
                </h2>
                <p className="font-body text-rose-700 leading-relaxed whitespace-pre-wrap">
                  {selected.content}
                </p>
                <div className="mt-6 text-right">
                  <p className="font-script text-rose-500 text-lg">
                    Dengan sepenuh cinta,
                  </p>
                  <p className="font-script text-rose-600 text-xl font-bold">
                    {selected.from_person} 🌿
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, from_person: e.target.value }))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, to_person: e.target.value }))
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  className="love-input resize-none paper-texture"
                  rows={8}
